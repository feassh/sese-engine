...
# Meilisearch 配置
meilisearch_host = 'http://158.180.68.161:7700'  # Meilisearch服务地址
meilisearch_key = 'feassh_meilisearch_master_key'  # API密钥，如果没有设置密钥则为None
meilisearch_batch_size = 100  # 批量处理文档数量
